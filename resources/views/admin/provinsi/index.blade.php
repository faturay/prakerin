        ...
        @if (session('message'))
            ...
            <div class="card">
             <div class="card-header">{{ __('Data Provinsi') }}
                <a href="{{route('provinsi.create')}}" class="float-right btn btn-success">Add Data</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                         ...
                         @foreach($provinsi as $data)
                            <tr>
                                ...
                                <td><form action="{{route('provinsi.destroy',$data->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <center><a href="{{route('provinsi.show',$data->id)}}" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></a></i>
