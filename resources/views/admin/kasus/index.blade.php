    ...
    <div class="row justify-content-center">
        <div class="col-md-20">
            <div class="card">
                ...
                <div class="card-body">
                <a href="{{route('kasus.create')}}"class="btn btn-primary float-right"><b>Tambah Data  <i class="fas fa-plus-circle"></i></b></a>
                <br></br>
                    @if (session('status'))
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($kasus2 as $data)
                      <tr>
                        <th scope="row">{{$no++}}</th>
                        <td>
                        <br>Provinsi : {{$data->rw->desa->kecamatan->kota->provinsi->nama_provinsi}}</br>
                        <br>Kota : {{$data->rw->desa->kecamatan->kota->nama_kota}}</br>
                        <br>Kecamatan : {{$data->rw->desa->kecamatan->nama_kecamatan}}</br>
                        <br>desa :{{$data->rw->desa->nama_desa}}</br>
                        </td>
